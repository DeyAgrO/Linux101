...
course numbers:
    ...
    course104           EXTRA: Networking, Logs & Web Server Troubleshooting
...
""",
        "course104": """
course103 details:
journalctl = See Log Information 
          example 1: journalctl -xeu httpd.service
          example 2: journalctl -xef
tail = Get the last 10 lines of a file
          example 1: tail -n 15 /var/log
          example 2: tail -f
"""
    }
